...
GOOGLE_CLIENT_ID = "258182076351-hk7v9k18ahf4nlgta99oprfuaovcfirv.apps.googleusercontent.com"
...
app.config['MONGO_URI']= 'mongodb+srv://admin:admin@cluster0.ql7f1.mongodb.net/ResumeRanking'
